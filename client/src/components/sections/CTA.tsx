  ...
  return (
    <section id="contact" className="py-40 px-6 md:px-12 bg-white text-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col items-center text-center relative z-10">
        ...
        >
          <h2 className="text-xs uppercase tracking-[0.2em] font-semibold text-black/40 mb-8">Audience Filter</h2>
          <h3 className="text-5xl md:text-7xl lg:text-8xl font-display font-light tracking-tight text-black mb-12 max-w-4xl">
            For those who demand technical supremacy.
          </h3>
          ...
          <button className="group relative px-8 py-4 bg-black text-white overflow-hidden rounded-sm flex items-center gap-4 hover:pr-6 transition-all duration-300">
            <span className="relative z-10 font-medium uppercase tracking-widest text-sm">Initiate Dialogue</span>
