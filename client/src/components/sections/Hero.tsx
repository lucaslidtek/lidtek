...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[80svh] md:min-h-[100svh] flex flex-col justify-center py-20 md:py-0 md:pb-24 px-6 md:px-12 bg-background overflow-hidden">
