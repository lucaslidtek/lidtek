...
export function Hero() {
  ...
  return (
    <section className="relative min-h-[100vh] flex flex-col justify-center pt-24 pb-20 px-6 md:pt-40 md:pb-32 md:px-12 bg-background overflow-hidden">
      {/* Background Image - Pawel Czerwinski abstract glass */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <picture>
          <source
            media="(max-width: 800px)"
            srcSet="/static/images/hero-background-mobile.webp"
          />
          <img
            src="/static/images/hero-background.webp"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-start gap-6 md:gap-8">
        ...
        >
          <div className="w-12 h-12 md:w-16 md:h-16 rounded-full border border-white/20 flex items-center justify-center bg-white/5 backdrop-blur-sm group-hover:bg-primary group-hover:border-primary group-hover:text-black transition-all duration-500 relative overflow-hidden">
            <ArrowDownRight size={20} className="relative z-10 text-white md:group-hover:text-background" />
          </div>
