...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-6 md:px-12 flex items-center justify-between mix-blend-difference bg-transparent">
      ...
      <div className="hidden md:flex items-center gap-8 font-medium text-sm z-50">
        <a href="#manifesto" className="text-white hover:text-[#6580E1] transition-colors uppercase tracking-widest">{t("nav.manifesto")}</a>
        <a href="#approach" className="text-white hover:text-[#6580E1] transition-colors uppercase tracking-widest">{t("nav.approach")}</a>
        <a href="#model" className="text-white hover:text-[#6580E1] transition-colors uppercase tracking-widest">{t("nav.model")}</a>
        ...
        <a 
          ...
          className="px-5 py-2 border border-white/20 hover:border-white hover:bg-white hover:text-black transition-all rounded-full uppercase tracking-widest text-white"
        >
          {t("nav.engage")}
        </a>
      </div>
