...
export function Navbar() {
  ...
  return (
    <nav className={`fixed top-4 left-1/2 -translate-x-1/2 w-[95%] max-w-7xl z-[100] px-6 py-4 md:px-8 flex items-center justify-between transition-all duration-500 rounded-full ${navClass} ${glassClass}`}>
