...
const translations = {
  pt: {
    ...
    'hero.title.line1': 'Sua empresa já',
    'hero.title.line2': 'tem tecnologia.',
    'hero.title.line3': 'A questão é:',
    'hero.title.line4': 'ela tem direção?',
  ...
  en: {
    ...
    'hero.tag': 'FOR COMPANIES ALREADY GROWING',
    'hero.title.line1': 'Your company already',
    'hero.title.line2': 'has technology.',
    'hero.title.line3': 'The question is:',
    'hero.title.line4': 'does it have direction?',
    'hero.explore': 'DISCOVER OUR STRUCTURE',
