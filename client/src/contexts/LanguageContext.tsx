...
const translations = {
  pt: {
    ...
    'model.tag': 'O Modelo Lidtek',
    'model.title': 'Tecnologia exige método.',
    'model.subtitle': 'Assumimos com estrutura.',
    'model.step1_title': 'Diagnóstico Estrutural',
    'model.step1_desc': 'Entendemos a base tecnológica atual da empresa.',
    'model.step2_title': 'Direção Técnica',
    'model.step2_desc': 'Definimos prioridades, arquitetura e decisões estratégicas.',
    'model.step3_title': 'Organização da Área',
    'model.step3_desc': 'Estruturamos responsabilidades, fluxo e governança.',
    'model.step4_title': 'Evolução Contínua',
    'model.step4_desc': 'Tecnologia não para. Acompanhamos, ajustamos e expandimos.',
    'model.step5_title': 'Liderança Ativa',
    'model.step5_desc': 'Assumimos responsabilidade real pela área tecnológica.',
  ...
  en: {
    ...
    'model.tag': 'The Lidtek Model',
    'model.title': 'Technology requires method.',
    'model.subtitle': 'We take over with structure.',
    'model.step1_title': 'Structural Diagnosis',
    'model.step1_desc': 'We understand the company\'s current technological base.',
    'model.step2_title': 'Technical Direction',
    'model.step2_desc': 'We define priorities, architecture, and strategic decisions.',
    'model.step3_title': 'Area Organization',
    'model.step3_desc': 'We structure responsibilities, flow, and governance.',
    'model.step4_title': 'Continuous Evolution',
    'model.step4_desc': 'Technology never stops. We monitor, adjust, and expand.',
    'model.step5_title': 'Active Leadership',
    'model.step5_desc': 'We take real responsibility for the technological area.',
