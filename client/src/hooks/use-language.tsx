...
const translations = {
  pt: {
    ...
    "approach.title": "Tecnologia com propósito e responsabilidade.",
    ...
    "ideal.title1": "Para empresas que cresceram.",
    "ideal.title2": "Estrutura agora é prioridade.",
  ...
  en: {
    ...
    "approach.title": "Technology with purpose and accountability.",
    ...
    "ideal.title1": "For companies that have grown.",
    "ideal.title2": "Structure is now a priority.",
