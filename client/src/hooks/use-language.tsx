...
const translations = {
  pt: {
    ...
    "problem.desc": "Tem um momento onde tecnologia deixa de ser solução e vira custo de manutenção. A operação cresce, as decisões ficam mais complexas, e os sistemas — sejam eles planilhas, softwares ou processos manuais — começam a frear o que deveria estar acelerando.",
    ...
    "manifesto.section_quote": "Tecnologia não é projeto. É a área que decide se o resto do negócio vai conseguir escalar.",
    ...
    "model.subtitle": "Tecnologia exige estrutura. E alguém que responda por ela.",
    ...
    "cta.desc": "A conversa não começa com proposta. Começa com entendimento. Você fala sobre sua operação. Nós falamos sobre o que faria sentido. Sem pitch. Sem solução pronta.",
