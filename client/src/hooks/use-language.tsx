...
const translations = {
  pt: {
    ...
    "terms.tag": "Acordo de Serviço",
    "terms.title1": "Termos de ",
    "terms.title2": "Serviço",
    "terms.desc": "Regras e responsabilidades que sustentam nossa parceria técnica e o compromisso com a excelência operacional.",
    "terms.s1.title": "1. Atuação",
    "terms.s1.desc": "Ao utilizar as soluções da Lidtek, você estabelece um acordo de conformidade com nossos padrões técnicos. Nossos serviços são desenhados para otimização e maturidade tecnológica, exigindo uso responsável da infraestrutura fornecida.",
    "terms.s2.title": "2. Propriedade",
    "terms.s2.desc": "Toda arquitetura de software, metodologias de engenharia e ativos digitais desenvolvidos pela Lidtek são protegidos por direitos de propriedade intelectual. A licença de uso é concedida especificamente para a operação do cliente, conforme definido em contrato.",
    "terms.s3.title": "3. Performance",
    "terms.s3.desc": "Nos comprometemos com a alta disponibilidade e integridade das soluções. A responsabilidade da Lidtek limita-se ao escopo técnico da engenharia contratada, garantindo que o software funcione como uma fundação sólida para o crescimento do seu negócio.",
    "terms.cta.title": "Parceria Estruturada",
    "terms.cta.desc": "Nossos termos refletem nossa postura de departamento de tecnologia premium: clareza, rigor e foco no resultado.",
    "privacy.tag": "Segurança e Dados",
    "privacy.title1": "Política de ",
    "privacy.title2": "Privacidade",
    "privacy.desc": "Transparência e proteção técnica são as bases da nossa operação. Entenda como cuidamos da sua integridade digital.",
    "privacy.s1.title": "1. Governança",
    "privacy.s1.desc": "A Lidtek opera sob os mais rigorosos padrões de engenharia de dados. Esta política detalha o tratamento de informações em conformidade com as melhores práticas de governança tecnológica.",
    "privacy.s2.title": "2. Coleta Técnica",
    "privacy.s2.desc": "Coletamos apenas dados essenciais para a performance dos nossos sistemas. Informações de contato corporativo e logs técnicos são processados exclusivamente para garantir a estabilidade e segurança das soluções entregues.",
    "privacy.s3.title": "3. Segurança Ativa",
    "privacy.s3.desc": "Implementamos criptografia de ponta e protocolos de acesso restrito. Seus dados não são apenas armazenados, são blindados por nossa arquitetura de segurança invisível, permitindo que sua operação flua sem riscos.",
    "privacy.cta.title": "Dúvidas sobre Proteção?",
    "privacy.cta.desc": "Nossa equipe de engenharia está à disposição para detalhar nossos protocolos de segurança."
  },
  en: {
    ...
    "terms.tag": "Service Agreement",
    "terms.title1": "Terms of ",
    "terms.title2": "Service",
    "terms.desc": "Rules and responsibilities that support our technical partnership and commitment to operational excellence.",
    "terms.s1.title": "1. Operation",
    "terms.s1.desc": "By using Lidtek's solutions, you establish an agreement of compliance with our technical standards. Our services are designed for optimization and technological maturity, requiring responsible use of the provided infrastructure.",
    "terms.s2.title": "2. Ownership",
    "terms.s2.desc": "All software architecture, engineering methodologies, and digital assets developed by Lidtek are protected by intellectual property rights. The usage license is granted specifically for the client's operation, as defined in the contract.",
    "terms.s3.title": "3. Performance",
    "terms.s3.desc": "We are committed to high availability and integrity of solutions. Lidtek's responsibility is limited to the technical scope of the contracted engineering, ensuring the software works as a solid foundation for your business growth.",
    "terms.cta.title": "Structured Partnership",
    "terms.cta.desc": "Our terms reflect our posture as a premium technology department: clarity, rigor, and focus on results.",
    "privacy.tag": "Security & Data",
    "privacy.title1": "Privacy ",
    "privacy.title2": "Policy",
    "privacy.desc": "Transparency and technical protection are the foundations of our operation. Understand how we care for your digital integrity.",
    "privacy.s1.title": "1. Governance",
    "privacy.s1.desc": "Lidtek operates under the most rigorous standards of data engineering. This policy details the treatment of information in compliance with the best practices of technological governance.",
    "privacy.s2.title": "2. Technical Collection",
    "privacy.s2.desc": "We collect only data essential for the performance of our systems. Corporate contact information and technical logs are processed exclusively to ensure the stability and security of delivered solutions.",
    "privacy.s3.title": "3. Active Security",
    "privacy.s3.desc": "We implement state-of-the-art encryption and restricted access protocols. Your data is not just stored, it is shielded by our invisible security architecture, allowing your operation to flow without risks.",
    "privacy.cta.title": "Questions about Protection?",
    "privacy.cta.desc": "Our engineering team is available to detail our security protocols."
  }
};
